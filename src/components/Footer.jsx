...
function Footer() {
    return (
        <section className='w-full bg-indigo-800 py-10'>
            {/* FOOTER TOP */}
            <footer class="mx-auto max-w-screen-xl py-6 px-6 sm:p-6 dark:bg-gray-900">
                <div class="grid grid-cols-1 sm:grid-cols-2  gap-8 sm:gap-7 md:grid-cols-4">
                    <div class="mb-4 md:mb-0">
                        <a href="#" class="flex items-center text-center">
                            <span class="text-center text-2xl font-semibold whitespace-nowrap text-white">Connect with Us</span>
                        </a>
                        <div class="flex mt-8 gap-8  sm:mt-8 align-bottom justify-start">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            ...
                            <li class="mb-2">
                                <a href="#" class="text-gray-200">About</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-gray-200">Resume Template</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-gray-200">Resume Examples</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-gray-200">Pricing</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-gray-200">FAQS</a>
                            </li>
                            <li class="mb-2">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-400 mt-3 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="#" class="hover:underline ">0712345678</a>
                            </li>
                            <li>
                                <a href="#" class="hover:underline">info@exampl.com</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h2 class="mb-6 text-sm font-semibold  uppercase text-white">newsletter</h2>
                        <div className="flex flex-col justify-start align-middle">
                            <p className="text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, saepe.</p>
                            <input type="text" className='my-3 rounded outline-none bg-transparent focus:outline-none  border-2 border-white focus:border-white text-white/50 ' />
                            <button className='py-2 mt-4 bg-transparent border-2  rounded font-semibold text-gray-200'>subscribe</button>
                        </div>
                    </div>
                </div>
            </footer>
            ...
            <div class="sm:flex sm:items-center sm:justify-center text-center">
                <span class="text-sm text-gray-400 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" class="hover:underline">JengaCv™</a>. All Rights Reserved.
                </span>
